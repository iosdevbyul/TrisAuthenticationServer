...
public struct APIError: AbortError, Sendable {
    ...
    public init(_ code: APIErrorCode, variant: Variant? = nil, retryAfter: Int? = nil) {
        self.code = code
        self.variant = variant
        self.retryAfter = retryAfter
    }
    public var status: HTTPResponseStatus { code.status }
    ...
    public var details: [APIValidationDetail]? {
