...
[Phase C completion and validation](docs/authentication-extraction-phase-c.md): package-owned HTTP routes, reduced public API, independent host/integration tests and local-package Docker/CI support.
